...
const LinkItems: Array<LinkItemProps> = [
  { name: 'Dashboard', icon: FiTrendingUp, link: '/workplaces' },
  { name: 'Estabelecimentos', icon: FiUsers, link: '/workplaces' },
  { name: 'Relatórios', icon: HiOutlineDocumentReport, link: '/workplaces' },
]
